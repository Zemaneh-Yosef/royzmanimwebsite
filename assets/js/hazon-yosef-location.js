 ...
 * 		timezoneSelect: import('@material/web/select/outlined-select.js').MdOutlinedSelect,
 * 		map: HTMLDivElement,
...
function openCalendarWithLocationInfo() {
	const locationArr = (isValidJSON(localStorage.getItem('hycal-customLocation'))
		? JSON.parse(localStorage.getItem('hycal-customLocation'))
		: []);
	...
	localStorage.setItem('hycal-customLocation', JSON.stringify(locationArr));
	localStorage.setItem('hycal-selectedLocation', geoLocation.locationName);
