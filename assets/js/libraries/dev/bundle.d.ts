...
declare const Utils: {
    getAllMethodNames: (obj: object, excludeContructors?: boolean) => string[];
};
declare const TimeZone: {
     ...
     * @param {boolean} [short]
     */
    getDisplayName: (timeZoneId: string, date?: DateTime, short?: boolean) => string;
    /**
