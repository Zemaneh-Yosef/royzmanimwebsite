declare module "polyfills/Utils" {
    ...
    export const Long_MIN_VALUE: number;
    /**
     * @param {number} num
...
declare module "polyfills/errors" {
...
declare module "util/GeoLocation" {
    /**
...
declare module "util/AstronomicalCalculator" {
    import { DateTime } from 'luxon';
...
declare module "util/NOAACalculator" {
    import { DateTime } from 'luxon';
    import { GeoLocation } from "util/GeoLocation";
...
declare module "AstronomicalCalendar" {
    import { DateTime } from 'luxon';
    import { GeoLocation } from "util/GeoLocation";
    import { AstronomicalCalculator } from "util/AstronomicalCalculator";
    /**
...
declare module "hebrewcalendar/Daf" {
    /**
...
declare module "hebrewcalendar/JewishDate" {
    import { DateTime } from 'luxon';
    /**
...
declare module "hebrewcalendar/JewishCalendar" {
    import { DateTime } from 'luxon';
...
declare module "ComplexZmanimCalendar" {
    import { DateTime } from 'luxon';
...
declare module "util/ZmanimFormatter" {
    import { DateTime } from 'luxon';
...
declare module "util/GeoLocationUtils" {
    import { GeoLocation } from "util/GeoLocation";
    /**
...
declare module "util/SunTimesCalculator" {
    import { DateTime } from 'luxon';
    import { GeoLocation } from "util/GeoLocation";
    import { AstronomicalCalculator } from "util/AstronomicalCalculator";
    /**
...
declare module "hebrewcalendar/YomiCalculator" {
    import { Daf } from "hebrewcalendar/Daf";
...
declare module "hebrewcalendar/YerushalmiYomiCalculator" {
    import { Daf } from "hebrewcalendar/Daf";
    import { JewishCalendar } from "hebrewcalendar/JewishCalendar";
    /**
...
declare module "hebrewcalendar/HebrewDateFormatter" {
    import { Daf } from "hebrewcalendar/Daf";
    import { JewishDate } from "hebrewcalendar/JewishDate";
    import { JewishCalendar, Parsha } from "hebrewcalendar/JewishCalendar";
    /**
...
declare module "kosher-zmanim" {
    ...
    export const Luxon: typeof _Luxon;
}
