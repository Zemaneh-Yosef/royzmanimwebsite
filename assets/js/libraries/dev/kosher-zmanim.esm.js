...
const _NOAACalculator = class _NOAACalculator extends AstronomicalCalculator {
  ...
  getUTCNoon(calendar, geoLocation) {
    const julianDay = _NOAACalculator.getJulianDay(calendar);
    const julianCenturies = _NOAACalculator.getJulianCenturiesFromJulianDay(julianDay);
    let noon = _NOAACalculator.getSolarNoonUTC(julianCenturies, -geoLocation.getLongitude());
    noon = noon / 60;
    while (noon < 0) {
      noon += 24;
    }
...
const _AstronomicalCalendar = class _AstronomicalCalendar {
  ...
  * "https://noaa.gov">NOAA's</a> implementation of Jean Meeus's algorithms as well as {@link
   ...
   */
  clone() {
    const clonedCalendar = new _AstronomicalCalendar(this.geoLocation);
...
var Parsha = /* @__PURE__ */ ((Parsha2) => {
  ...
  Parsha2[Parsha2["SHUVA"] = 66] = "SHUVA";
  Parsha2[Parsha2["SHIRA"] = 67] = "SHIRA";
  Parsha2[Parsha2["HAGADOL"] = 68] = "HAGADOL";
  Parsha2[Parsha2["CHAZON"] = 69] = "CHAZON";
  Parsha2[Parsha2["NACHAMU"] = 70] = "NACHAMU";
  return Parsha2;
})(Parsha || {});
const _JewishCalendar = class _JewishCalendar extends JewishDate {
  constructor(jewishYearOrDateTimeOrDate, jewishMonth, jewishDayOfMonth, inIsrael) {
    ...
    */
    __publicField$b(this, "isMukafChoma", false);
    /**
...
__publicField$b(_JewishCalendar, "ISRU_CHAG", 35);
/**
...
*/
__publicField$b(_JewishCalendar, "YOM_KIPPUR_KATAN", 36);
/**
...
* @see #isBeHaB()
*/
__publicField$b(_JewishCalendar, "BEHAB", 37);
/**
 ...
 */
__publicField$6(_ZmanimFormatter, "SEXAGESIMAL_XSD_FORMAT", 0 /* SEXAGESIMAL_XSD_FORMAT */);
/**
 * Format using standard decimal format with 5 positions after the decimal.
 */
__publicField$6(_ZmanimFormatter, "DECIMAL_FORMAT", 1 /* DECIMAL_FORMAT */);
/** Format using hours and minutes. */
__publicField$6(_ZmanimFormatter, "SEXAGESIMAL_FORMAT", 2 /* SEXAGESIMAL_FORMAT */);
/** Format using hours, minutes and seconds. */
__publicField$6(_ZmanimFormatter, "SEXAGESIMAL_SECONDS_FORMAT", 3 /* SEXAGESIMAL_SECONDS_FORMAT */);
/** Format using hours, minutes, seconds and milliseconds. */
__publicField$6(_ZmanimFormatter, "SEXAGESIMAL_MILLIS_FORMAT", 4 /* SEXAGESIMAL_MILLIS_FORMAT */);
/** constant for milliseconds in a minute (60,000) */
...
const _SunTimesCalculator = class _SunTimesCalculator extends AstronomicalCalculator {
  ...
  */
  getUTCNoon(calendar, geoLocation) {
    const sunrise = this.getUTCSunrise(calendar, geoLocation, 90, true);
    const sunset = this.getUTCSunset(calendar, geoLocation, 90, true);
...
const _Daf = class _Daf {
  ...
  * @param masechtosYerushalmiTransliterated the list of transliterated Yerushalmi <em>masechtos</em> to set.
   */
  static setYerushalmiMasechtaTransliterated(masechtosYerushalmiTransliterated) {
  ...
  */
  static getYerushalmiMasechtosTransliterated() {
  ...
  *         &#x05D1;&#x05E8;&#x05DB;&#x05D5;&#x05EA; for Berachos.
  ...
  getYerushalmiMasechta() {
    return _Daf.masechtosYerushalmi[this.masechtaNumber];
  }
};
/**
 ...
 */
__publicField$3(_Daf, "masechtosYerushalmi", [
  "\u05D1\u05E8\u05DB\u05D5\u05EA",
  "\u05E4\u05D9\u05D0\u05D4",
  "\u05D3\u05DE\u05D0\u05D9",
  "\u05DB\u05DC\u05D0\u05D9\u05D9\u05DD",
...
const _YerushalmiYomiCalculator = class _YerushalmiYomiCalculator {
  ...
  static getDafYomiYerushalmi(jewishCalendar) {
    ...
    if (requested < _YerushalmiYomiCalculator.DAF_YOMI_START_DAY) {
      throw new IllegalArgumentException(`${requested} is prior to organized Daf Yomi Yerushalmi cycles that started on ${_YerushalmiYomiCalculator.DAF_YOMI_START_DAY}`);
    }
