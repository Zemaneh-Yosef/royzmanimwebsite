...
//#endregion
//#region src/util/GeoLocation.d.ts
/**
...
//#endregion
//#region src/util/ZmanimFormatter.d.ts
...
//#endregion
//#region src/hebrewcalendar/JewishDate.d.ts
...
//#endregion
//#region src/polyfills/Utils.d.ts
...
//#endregion
//#region src/hebrewcalendar/limud/_Daf.d.ts
/**
...
//#endregion
//#region src/hebrewcalendar/limud/YomiCalculator.d.ts
/**
 * Represents a range of Daf Yomi entries for two dates.
 */
interface DafYomiRange {
  /** The first Daf entry */
  daf1: DafBavliYomi;
  /** The second Daf entry */
  daf2: DafBavliYomi;
  /** Whether both entries are in the same masechta */
  sameMasechta: boolean;
  /** Whether the dafim are consecutive (difference of 1) */
  isConsecutive: boolean;
  /** The absolute difference between the daf numbers */
  dafDifference: number;
  /** The total number of pages in the range (difference + 1) */
  totalPages: number;
}
/**
 * Represents a range of Daf Yomi entries for multiple dates.
 */
interface DafYomiRangeMultiple {
  /** Array of Daf entries */
  dafim: DafBavliYomi[];
  /** Whether all entries are in the same masechta */
  allSameMasechta: boolean;
  /** The minimum daf number in the range */
  minDaf?: number;
  /** The maximum daf number in the range */
  maxDaf?: number;
  /** Whether the dafim form a consecutive range */
  isConsecutiveRange?: boolean;
  /** The total number of pages in the range */
  totalPages?: number;
}
/**
 * Represents just the daf numbers for two dates (without full Daf objects).
 */
interface DafNumbersRange {
  /** The first daf number */
  dafNum1: number;
  /** The second daf number */
  dafNum2: number;
  /** Whether both entries are in the same masechta */
  sameMasechta: boolean;
  /** The masechta name (in Hebrew) */
  masechtaName: string;
  /** The masechta name (transliterated) */
  masechtaTransliterated: string;
  /** The absolute difference between the daf numbers */
  dafDifference: number;
  /** The total number of pages in the range (difference + 1) */
  totalPages: number;
  /** Whether the dafim are consecutive (difference of 1) */
  isConsecutive: boolean;
  /** The minimum daf number */
  minDaf: number;
  /** The maximum daf number */
  maxDaf: number;
}
/**
...
declare class DafYomiCalculator {
  ...
  private static getJulianDay;
  /**
  * Returns the Daf Yomi (Bavli) entries for two dates.
  *
  * @param date1 The first date
  * @param date2 The second date
  * @return An object containing both Daf entries and their relationship
  *
  * @throws IllegalArgumentException if either date is prior to the Daf Yomi start date
  */
  static getDafYomiRange(date1: JewishDate, date2: JewishDate): DafYomiRange;
  /**
   * Returns the Daf Yomi (Bavli) entries for multiple dates.
   *
   * @param dates Array of JewishDate objects
   * @return An object containing all Daf entries and their relationship
   *
   * @throws IllegalArgumentException if any date is prior to the Daf Yomi start date
   */
  static getDafYomiRangeMultiple(dates: JewishDate[]): DafYomiRangeMultiple;
  /**
   * Returns just the daf numbers for two dates (useful for quick comparison).
   *
   * @param date1 The first date
   * @param date2 The second date
   * @return An object with the daf numbers and their relationship
   *
   * @throws IllegalArgumentException if either date is prior to the Daf Yomi start date
   */
  static getDafNumbersRange(date1: JewishDate, date2: JewishDate): DafNumbersRange;
}
/**
 * An Object representing a <em>daf</em> (page) in the <a href="https://en.wikipedia.org/wiki/Daf_Yomi">Daf Yomi</a> cycle.
 *
...
//#endregion
//#region src/hebrewcalendar/limud/YerushalmiYomiCalculator.d.ts
/**
...
declare class YerushalmiYomiCalculator {
  ...
  /**
   * Formats the Yerushalmi Daf Yomi range between two dates.
   * Handles Tisha B'Av and Yom Kippur by skipping those days.
   *
   * @param startDate - The start date
   * @param endDate - The end date
   * @param hebrewFormat - Whether to use Hebrew (true) or transliterated (false)
   */
  static formatDafRange(startDate: JewishDate, endDate: JewishDate, hebrewFormat?: boolean): {
    firstDaf: DafYomiYerushalmi;
    lastDaf: DafYomiYerushalmi;
  };
}
/**
 * An Object representing a <em>daf</em> (page) in the <a href="https://en.wikipedia.org/wiki/Daf_Yomi">Daf Yomi</a> cycle.
...
//#endregion
//#region src/util/Parsha/ParshaMap.d.ts
/**
...
//#endregion
//#region src/hebrewcalendar/JewishCalendar.d.ts
...
//#endregion
//#region src/hebrewcalendar/TefilaRules.d.ts
/**
...
//#endregion
//#region src/hebrewcalendar/limud/ChafetzChayimYomiCalculator.d.ts
...
//#endregion
//#region src/hebrewcalendar/limud/Hiloulah.d.ts
type HiloulahObj = {
  name: string;
  src: string;
}[];
declare class HiloulahYomiCalculator {
  private folderWithHiloulotJSON;
  private initPromise;
  private hiloulot_en;
  private hiloulot_he;
  ...
  private mergeHiloulot;
}
//#endregion
//#region src/hebrewcalendar/limud/TehilimYomi.d.ts
...
//#endregion
//#region src/hebrewcalendar/limud/HaftarahShvui.d.ts
/**
...
//#endregion
//#region src/hebrewcalendar/limud/MaqamShvui.d.ts
/**
 * This class's main goal is to return the Weekly Haftorah reading said after the Weekly Parasha
 * reading. Which readings to say were taken from the Chumash "L'maan Shemo B'Ahavah" according to
 * the Sepharadic Minhag.
...
//#endregion
//#region src/hebrewcalendar/limud/MishnaYomi.d.ts
declare class MishnaYomi {
   ...
   */
  static getMishnaRange(startDate: JewishDate, endDate: JewishDate, useHebrewText: boolean): string[];
  /**
   ...
   */
  static getMishnaRangeAsString(startDate: JewishDate, endDate: JewishDate, useHebrewText: boolean, separator?: string): string;
  static getMishnaRangeSummary(startDate: JewishDate, endDate: JewishDate, useHebrewText: boolean): string;
  /**
...
interface WeeklyLearning {
  weekStart: JewishDate;
  weekEnd: JewishDate;
  jewishWeekStart: string;
  jewishWeekEnd: string;
  weekNumber: number;
  days: DailyLearning[];
  weeklyRange: string;
...
declare class HalachaYomi {
  ...
  /**
   * Initialize START_DATE to November 12, 2020
   */
  private static initStartDate;
  /**
   ...
   */
  private static getJewishDayOfWeek;
  /**
   * Get the start of the Jewish week (Sunday) for a given date
   */
  private static getJewishWeekStart;
  /**
   * Format Hebrew date using the HebrewDateFormatter
   */
  private static formatHebrewDate;
  /**
   * Format Hebrew day of week
   */
  private static formatHebrewDayOfWeek;
  /**
   * Get Rosh Hashanah for the Jewish year of the given date
   */
  private static getRoshHashanah;
  /**
   * Get the Jewish week number for a given date
   */
  private static getJewishWeekNumber;
  /**
   ...
   */
  static getWeeklyLearning(date?: JewishDate): WeeklyLearning;
  /**
   * Get a formatted string showing the weekly learning progression
   */
  static getWeeklyLearningString(date?: JewishDate): string;
  /**
   * Get a condensed weekly summary
   */
  static getWeeklySummary(date?: JewishDate): string;
  /**
   * Get a compact one-line summary
   */
  static getWeeklyCompact(date?: JewishDate): string;
  /**
...
//#endregion
//#region src/hebrewcalendar/limud/MishneTora.d.ts
interface RambamReading {
  bookName: string;
  chapters: number[];
}
declare class DailyMishnehTorah {
  private static readonly CYCLE_LENGTH;
  private static readonly START_DATE;
  ...
  private static combineReadings;
  /**
   * Helper function to display a reading in a readable format
   */
  static formatReading(reading: RambamReading): string;
  private static getChapterByIndex;
}
//#endregion
//#region src/hebrewcalendar/HebrewDateFormatter.d.ts
/**
...
declare class HebrewDateFormatter {
  ...
  /**
   * Formats a Daf Yomi range that was calculated by DafYomiCalculator.
   *
   * @param range The DafYomiRange object from DafYomiCalculator.getDafYomiRange()
   * @return A formatted string
   * @example
   * // If today is Bava Metzia 2 and tomorrow is Bava Metzia 3
   * // Returns "בבא מציעא ב' ג'" (in Hebrew format) or "Bava Metzia 2-3" (in transliterated format)
   */
  formatDafYomiRange(range: DafYomiRange): string;
  /**
   * Formats a Daf Yomi range for multiple dates.
   *
   * @param range The DafYomiRangeMultiple object from DafYomiCalculator.getDafYomiRangeMultiple()
   * @return A formatted string
   */
  formatDafYomiRangeMultiple(range: DafYomiRangeMultiple): string;
  formatDafYerushalmiYomiRange(firstDaf: Daf, lastDaf: Daf): string;
}
//#endregion
...
//#endregion
export { AstronomicalCalendar, Calendar, ChafetzChayimYomiCalculator, DafYomiCalculator, DafYomiYerushalmi, DailyMishnehTorah, GeoLocation, WeeklyHaftarahReading as Haftara, HalachaYomi, HebrewDateFormatter, HiloulahYomiCalculator, IntegerUtils, JewishCalendar, JewishDate, Long_MIN_VALUE, WeeklyMakamReading as Makam, MathUtils, MishnaYomi, Options, Parsha, ParshaMap, SPACalculator, StringUtils, TefilaRules, TehilimYomi, Time, TimeZone, Utils, YerushalmiYomiCalculator, ZmanimCalendar, _Big, getZmanimJson, padZeros, temporalExtended };
