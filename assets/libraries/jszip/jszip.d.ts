...
//#region node_modules/.pnpm/jszip@3.10.1/node_modules/jszip/index.d.ts
...
interface JSZip {
  ...
  file<T extends JSZip.InputType>(path: string, data: null, options?: JSZip.JSZipFileOptions & {
    dir: true;
  }): this;
  /**
